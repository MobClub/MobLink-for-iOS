        ...
        case $mob.shareSDK.contentType.MiniProgram:
        {
            ...
            if (webpageUrl != null && userName != null)
            {
                ...
                this._convertUrl(platformType , [text, url], function (data) {
                    ...
                    $mob.ext.ssdk_wechatShareMiniProgram(self.appID(), scene, title, text, thumbImage, userName, path, webpageUrl, function (data) {
...
WeChat.prototype._shareWithoutSDK = function (sessionId, parameters, userData, callback)
{
    ...
    //构造分享参数
    var shareParameter = {"result":"1","returnFromApp":"0","scene":String(scene),"sdkver":"1.7.7","command":"1010"};
