 ...
 * @param callback          回调
 */
$mob.ext.ssdk_wechatShareMiniProgram = function (appId, scene, title, desc, thumbImage, userName, path, webpageURL, callback)
{
    var func = $mob.ext._bindCallbackFunc(callback);
    $mob.native.ssdk_plugin_wechat_share(appId, scene, $mob.shareSDK.contentType.MiniProgram, func, title, desc, thumbImage, userName, path, webpageURL);
};
 ...
 * @param callback              回调
 */
$mob.ext.ssdk_facebookmessengerShareImage = function (images, callback)
{
    var func = $mob.ext._bindCallbackFunc(callback);
    $mob.native.ssdk_plugin_facebookmessenger_share ($mob.shareSDK.contentType.Image, func, images);
};
 ...
 * @param callback              回调
 */
$mob.ext.ssdk_facebookmessengerShareGif = function (gif, callback)
{
    var func = $mob.ext._bindCallbackFunc(callback);
    $mob.native.ssdk_plugin_facebookmessenger_share ($mob.shareSDK.contentType.Image, func, null ,gif);
};
 ...
 * @param callback               回调
 */
$mob.ext.ssdk_facebookmessengerShareAudio = function (audio, callback)
{
    var func = $mob.ext._bindCallbackFunc(callback);
    $mob.native.ssdk_plugin_facebookmessenger_share ($mob.shareSDK.contentType.Audio, func, audio);
};
 ...
 * @param callback               回调
 */
$mob.ext.ssdk_facebookmessengerShareVideo = function (video, callback)
{
    var func = $mob.ext._bindCallbackFunc(callback);
    $mob.native.ssdk_plugin_facebookmessenger_share ($mob.shareSDK.contentType.Video, func, video);
};
